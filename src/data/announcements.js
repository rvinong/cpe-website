...
export const announcements = [
  {
    ...
    body: [
      'Our Computer Engineering Organization website is currently under development. This platform will soon provide announcements, academic resources, event updates, curriculum information, organization highlights, alumni archive, and other helpful features for students.',
