            ...
            return (
              <Reveal key={item.title} delay={index * 0.055}>
                ...
                >
                  ...
                  <span className="absolute -right-8 -top-8 size-28 rounded-full bg-brand-50/70 transition duration-500 group-hover:scale-150 group-hover:bg-brand-100/70" />
                  <span className="absolute -bottom-10 left-6 h-16 w-28 rotate-[-12deg] rounded-full bg-orange-50 opacity-0 blur-2xl transition duration-500 group-hover:opacity-80" />
